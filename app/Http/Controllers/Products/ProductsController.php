...
class ProductsController extends Controller
{
    ...
    public function addToCart(Request $request) {
        ...
        if ($addCart) {
            ...
            return Redirect::route("single.product", $request->pro_id)->with(['success' => 'Product Added To Cart Succssfully']);
    ...
    public function deleteFromCart($id) {
        ...
        if ($deleteCart) {
            ...
            return Redirect::route("products.cart")->with(['delete' => 'Product Deleted From Cart Succssfully']);
